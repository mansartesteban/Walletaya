export default function useDrag(element) {
    ...
    const drag = (e) => {
        transform.value.x = [originalTransform.x + e.changedTouches[0].clientX - offset.value.x, "px"].join("")
        transform.value.y = [originalTransform.y + e.changedTouches[0].clientY - offset.value.y, "px"].join("")
