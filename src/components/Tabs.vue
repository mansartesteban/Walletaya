<template>
  ...
  <div v-if="tabsContent" class="tab-headers scroll-snap-x">
    <nav ref="tabHeaderContainer" class="tab-header-container flex align-items-center">
      <!-- Tab headers -->
      <div class="tab-header" v-for="(tab, i) in tabsContent" @click="repositionTab(tab.props.anchor)">
  ...
  <template v-for="defaultContent in defaultContents">
    <component :is="defaultContent.is" v-bind="defaultContent.attrs"></component>
  </template>
  ...
  <div ref="tabs" class="tabs-content-container scroll-snap-x">
    ...
    <Tab v-for="tab in tabsContent" v-bind="tab.props">
      <component :is="tab.is" v-bind="tab.props"></component>
    </Tab>
  </div>
</template>
